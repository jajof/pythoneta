...
def demonstrate_custom_operators_jh():
...
#
    ...
    check_stations_task = HasRowsOperator(redshift_conn_id='redshift', 
                                          table= 'stations',
...
custom_operators_dag = demonstrate_custom_operators_jh()